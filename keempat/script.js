...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyConfig() {
        if (window.CONFIG) {
            ...
            if (subtitle) {
                subtitle.textContent = `Hai Hai Sayangg, ${CONFIG.messages.subtitle}`;
            }
            ...
            if (loveNoteText) {
                loveNoteText.textContent = `Ucii, ${CONFIG.messages.loveNote}`;
            }
            ...
            if (specialMessageTitle) {
                specialMessageTitle.textContent = `Untuk CintaKu ${CONFIG.partnerName}`;
            }
